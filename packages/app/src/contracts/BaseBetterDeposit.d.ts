...
interface BaseBetterDepositInterface extends ethers.utils.Interface {
  functions: {
...
export class BaseBetterDeposit extends Contract {
  ...
  interface: BaseBetterDepositInterface;
